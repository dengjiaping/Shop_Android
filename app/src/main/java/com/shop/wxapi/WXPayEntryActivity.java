...
public class WXPayEntryActivity extends BaseActvity implements IWXAPIEventHandler {
    ...
    protected void init() {
        initTitle("支付订单");
        F();
//         HEAD:app/src/main/java/com/shop/Android/wxapi/WXPayEntryActivity.java


        msgApi = WXAPIFactory.createWXAPI(WXPayEntryActivity.this, null);
// d26b9bdc947e88b321544c37969abad431eda880:app/src/main/java/com/shop/wxapi/WXPayEntryActivity.java
